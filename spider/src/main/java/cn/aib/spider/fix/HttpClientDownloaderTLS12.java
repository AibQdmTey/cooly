/*
 * HttpClientDownloaderTLS12.java
 * Copyright 2019 Qunhe Tech, all rights reserved.
 * Qunhe PROPRIETARY/CONFIDENTIAL, any form of usage is subject to approval.
 */

package cn.aib.spider.fix;
 ...
 */
public class HttpClientDownloaderTLS12 extends AbstractDownloader {
    private Logger logger = LoggerFactory.getLogger(this.getClass());
    private final Map<String, CloseableHttpClient> httpClients = new HashMap();
    private HttpClientGeneratorTLS12 httpClientGenerator = new HttpClientGeneratorTLS12();
    private HttpUriRequestConverter httpUriRequestConverter = new HttpUriRequestConverter();
    private ProxyProvider proxyProvider;
    private boolean responseHeader = true;

    public HttpClientDownloaderTLS12() {
    }
    ...
    public Page download(Request request, Task task) {
        if (task != null && task.getSite() != null) {
            ...
            HttpClientRequestContext requestContext = this.httpUriRequestConverter.convert(request,
                    task.getSite(), proxy);
            Page page = Page.fail();
            ...
            try {
                ...
                page = this.handleResponse(request,
                        request.getCharset() != null ? request.getCharset()
