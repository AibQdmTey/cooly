 ...
 */
public class HttpClientGeneratorTLS12 {
    private transient Logger logger = LoggerFactory.getLogger(this.getClass());
    private PoolingHttpClientConnectionManager connectionManager;

    public HttpClientGeneratorTLS12() {
    ...
    public HttpClientGeneratorTLS12 setPoolSize(int poolSize) {
    ...
    private void generateCookie(HttpClientBuilder httpClientBuilder, Site site) {
        if (site.isDisableCookieManagement()) {
            ...
            while (var4.hasNext()) {
                ...
                BasicClientCookie cookie = new BasicClientCookie((String) domainEntry.getKey(),
                        (String) domainEntry.getValue());
